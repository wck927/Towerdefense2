...
void MainWindow::paintEvent(QPaintEvent *)
{
    ...
    {
        QString text = m_gameEnded ? "很遗憾，你失败了" : "恭喜你，胜利！";
...
void MainWindow::addWayPoints()
{
    ...
    WayPoint *wayPoint2 = new WayPoint(QPoint(15, 285));
    m_wayPointsList.push_back(wayPoint2);
    wayPoint2->setNextWayPoint(wayPoint1);

    WayPoint *wayPoint3 = new WayPoint(QPoint(15, 195));
    ...
    WayPoint *wayPoint6 = new WayPoint(QPoint(15, 100));
...
void MainWindow::on_Strat_clicked()
{
    loadWave();
}
